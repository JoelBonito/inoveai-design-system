...
function SelectBasicPreview() {
  return (
    <div className="relative w-full max-w-xs">
      <select className="bg-background border-border text-foreground focus:ring-primary w-full appearance-none rounded-lg border px-4 py-2 pr-8 leading-tight transition-all focus:border-transparent focus:ring-2 focus:outline-none">
        <option>Selecione uma opção</option>
        <option>Opção 1</option>
        <option>Opção 2</option>
        <option>Opção 3</option>
...
function SelectStatesPreview() {
  return (
    <>
      <div className="relative w-full max-w-xs cursor-not-allowed opacity-50">
        <select
          disabled
          className="bg-muted border-border text-muted-foreground w-full cursor-not-allowed appearance-none rounded-lg border px-4 py-2 pr-8 leading-tight"
        >
          <option>Desabilitado</option>
        </select>
        <div className="text-muted-foreground pointer-events-none absolute inset-y-0 right-0 flex items-center px-2">
      ...
      <div className="relative w-full max-w-xs">
        <select className="bg-background border-destructive text-foreground focus:ring-destructive w-full appearance-none rounded-lg border-2 px-4 py-2 pr-8 leading-tight transition-all focus:ring-2 focus:outline-none">
          <option>Erro de validação</option>
        </select>
        <div className="text-destructive pointer-events-none absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="h-4 w-4 fill-current"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
