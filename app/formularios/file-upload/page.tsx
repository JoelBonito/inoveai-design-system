...
function FileUploadDropzonePreview() {
  return (
    <div className="flex w-full max-w-lg items-center justify-center">
      <label className="border-border bg-accent hover:bg-accent/80 flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed transition-colors">
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
          ...
          <p className="text-muted-foreground mb-2 text-sm">
            <span className="text-primary font-semibold">Clique para upload</span> ou arraste
          </p>
...
function FileUploadCompactPreview() {
  return (
    <div className="flex items-center gap-4">
      <label className="bg-primary hover:bg-primary/90 cursor-pointer rounded-lg px-4 py-2 font-medium text-white shadow-sm transition-colors">
        Escolher arquivo
        <input type="file" className="hidden" />
      </label>
      <span className="text-muted-foreground text-sm">Nenhum arquivo selecionado</span>
    </div>
  );
}
...
function FileUploadListPreview() {
  return (
    <div className="w-full max-w-md space-y-4">
      <div className="bg-card border-border flex items-center gap-4 rounded-lg border p-3 shadow-sm">
        <div className="bg-muted text-muted-foreground flex size-10 items-center justify-center rounded">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-foreground truncate text-sm font-medium">screenshot-2024.png</p>
