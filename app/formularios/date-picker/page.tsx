...
function DatePickerRangePreview() {
  return (
    <div className="bg-background border-border flex max-w-sm items-center gap-2 rounded-lg border p-2">
      <div className="relative flex-1">
        <input
          type="date"
          className="text-foreground w-full border-none bg-transparent p-1 text-sm focus:ring-0"
        />
      </div>
...
function DatePickerTriggerPreview() {
  return (
    <button className="border-border bg-background hover:bg-accent text-foreground flex items-center gap-2 rounded-lg border px-4 py-2 transition-colors">
      <svg
