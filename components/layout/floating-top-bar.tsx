...
export function FloatingTopBar() {
    ...
    return (
        <header className="sticky top-4 z-40 mx-6 mb-2 rounded-2xl border border-border/20 bg-transparent px-4 py-3 backdrop-blur-md">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div
                        className="relative flex items-center bg-muted rounded-full p-1 cursor-pointer w-14 h-7 transition-colors border border-border"
